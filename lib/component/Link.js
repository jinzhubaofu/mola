(function (global, factory) {
    ...
    Link.propTypes = {
        ...
        top: _react.PropTypes.oneTypeOf([_react.PropTypes.string, _react.PropTypes.number]).isRequired,
        left: _react.PropTypes.oneTypeOf([_react.PropTypes.string, _react.PropTypes.number]).isRequired,
        width: _react.PropTypes.oneTypeOf([_react.PropTypes.string, _react.PropTypes.number]).isRequired,
        height: _react.PropTypes.oneTypeOf([_react.PropTypes.string, _react.PropTypes.number]).isRequired
    };
