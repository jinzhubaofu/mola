(function (global, factory) {
        ...
        Link.prototype.render = function render() {
            ...
            if (action === 'link') {
                var _props2 = this.props,
                    ...
                    href = _props2.href,
                    tapHighlight = _props2.tapHighlight;
    ...
    Link.propTypes = {
        ...
        target: _react.PropTypes.oneOf(['_blank', '_self']),
        ...
        anchorId: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.number]),
