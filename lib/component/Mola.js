(function (global, factory) {
    ...
    var Mola = function (_Component) {
        ...
        Mola.prototype.resolveTreeNode = function resolveTreeNode(type, version) {
            return (0, _factory.getComponent)(type, version);
        };
        ...
        Mola.prototype.traverse = function traverse(root, index, level, filter) {
            ...
            var type = root.type,
                ...
                props = babelHelpers.objectWithoutProperties(root, ['type', 'version', 'children']);
            ...
            return this.renderTreeNode(this.resolveTreeNode(type, version), props, children, index, level, filter);
        };
